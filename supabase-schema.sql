...
DROP POLICY IF EXISTS "Users can view wines from own scans" ON public.wine_results;
...
DROP POLICY IF EXISTS "Users can insert wines to own scans" ON public.wine_results;
...
DROP POLICY IF EXISTS "Users can update wines from own scans" ON public.wine_results;
...
DROP POLICY IF EXISTS "Users can delete wines from own scans" ON public.wine_results;
...
DROP POLICY IF EXISTS "Anyone can read wine cache" ON public.wine_cache;
CREATE POLICY "Anyone can read wine cache"
  ON public.wine_cache FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Only service role can modify wine cache" ON public.wine_cache;
